  ...
  return (
    <>
      <div className="grid w-[100%] h-screen bg-primary text-white">
        <div className="grid mt-[32px] place-self-center w-[90%] lg:w-[50%] h-[80%] bg-secondary rounded-lg p-5">
            ...
            <div>
              ...
              <div className="grid place-content-center">
                <div className="grid grid-cols-2 w-[80%] gap-5">
                  {/* LinkedIn */}
                  <Link
                    className="bg-action rounded-xl px-2 shadow-xl"
                  ...
                  {/* Github */}
                  <Link
                    className="grid place-content-center bg-action rounded-xl shadow-xl"
