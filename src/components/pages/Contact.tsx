...
const Contact: React.FC = () => {
  return (
    <>
      <div className="grid w-[100%] h-screen bg-primary text-white">
        <div className="grid mt-[32px] place-self-center w-[90%] lg:w-[50%] h-fit bg-secondary rounded-lg p-5">
          <div className="w-[100%] h-[100%] lg:grid lg:grid-cols-2 lg:gap-6 p-2">
            ...
            <div className="grid place-content-center">
              <div className="grid grid-cols-2 w-[80%] gap-5 place-self-center">
                {/* LinkedIn */}
                <Link
                  className="bg-action rounded-xl px-2 shadow-xl transition ease-in-out delay-50 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
                ...
                {/* Github */}
                <Link
                  className="grid place-content-center bg-action rounded-xl shadow-xl transition ease-in-out delay-50 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300"
